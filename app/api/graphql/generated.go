...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateAccount func(childComplexity int, input models.NewAccount) int
	}
...
type MutationResolver interface {
	CreateAccount(ctx context.Context, input models.NewAccount) (*models.Account, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createAccount":
		...
		return e.complexity.Mutation.CreateAccount(childComplexity, args["input"].(models.NewAccount)), true
...
var sources = []*ast.Source{
	&ast.Source{Name: "schema.graphql", Input: `# GraphQL schema example: https://gqlgen.com/getting-started/
...
func (ec *executionContext) field_Mutation_createAccount_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 models.NewAccount
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewAccount2mixᚋappᚋapiᚋmodelsᚐNewAccount(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createAccount(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateAccount(rctx, args["input"].(models.NewAccount))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNAccount2ᚖmixᚋappᚋapiᚋmodelsᚐAccount(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_accounts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*models.Account)
	fc.Result = res
	return ec.marshalNAccount2ᚕᚖmixᚋappᚋapiᚋmodelsᚐAccountᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewAccount(ctx context.Context, obj interface{}) (models.NewAccount, error) {
	var it models.NewAccount
	...
	for k, v := range asMap {
		...
		case "phoneOrEmail":
			var err error
			it.PhoneOrEmail, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) marshalNAccount2mixᚋappᚋapiᚋmodelsᚐAccount(ctx context.Context, sel ast.SelectionSet, v models.Account) graphql.Marshaler {
	return ec._Account(ctx, sel, &v)
}

func (ec *executionContext) marshalNAccount2ᚕᚖmixᚋappᚋapiᚋmodelsᚐAccountᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Account) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNAccount2ᚖmixᚋappᚋapiᚋmodelsᚐAccount(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNAccount2ᚖmixᚋappᚋapiᚋmodelsᚐAccount(ctx context.Context, sel ast.SelectionSet, v *models.Account) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNNewAccount2mixᚋappᚋapiᚋmodelsᚐNewAccount(ctx context.Context, v interface{}) (models.NewAccount, error) {
